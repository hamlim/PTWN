		...
		<header class="header">
			...
			<nav>
				<div class="uk-grid">
					...
					<h1 class="centre-title uk-width-1-3 uk-text-center"><span class="uk-container-center">Welcome to Trends</span></h1><!-- NOTE: this will change when we introduce multiple sections-->
...
<!--
			<section class="uk-align-center uk-panel uk-panel-space uk-panel-divider uk-panel-box uk-panel-box-secondary uk-container-center my-width">
				<h3 class="uk-panel-title my-title">What is Trends?</h1>
				<p>Trends is a curated news feed for you, the user. Trends is full of sections that are created by curation specialists to create a better news reading experience. We the editors add in new secttions almost everyday!</p>
			</section>
			<section class="uk-align-center uk-panel uk-panel-space uk-panel-divider uk-panel-box uk-panel-box-secondary uk-container-center my-width">
			...
			<section class="uk-text-center uk-align-center uk-panel uk-panel-box uk-panel-box-secondary uk-container-center my-width-footer">
				<span>Trends was developed independently by Matt Hamlin at Forge Labs. </span>
			</section>
-->
		</article>
