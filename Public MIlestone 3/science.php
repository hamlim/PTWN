<?php
	...
	$settings = array(
			'oauth_access_token' => "118285131-3neUlF1VYZhOrHzY5jhWDjN7SvEvn63vonvHQrOA",
			'oauth_access_token_secret' => "lUKDzkHCUqUj01NEJMjcry2V4ZvkVDjn07hAaiVNp5HF5",
			'consumer_key' => "JPAfonKWDF2mk3xFdG9Vt3JOx",
			'consumer_secret' => "znQrv6QFiZdSIbf2aJfAwscMW60Uph63WBRGk2WQBYPjtkLi4J"
	);
	...
	$getfields1 = '?screen_name=NASA&count=10';
	$getfields2 = '?screen_name=newscientist&count=10';
	$getfields3 = '?screen_name=wiredscience&count=10';
	$getfields4 = '?screen_name=sciam&count=10';
	$getfields5 = '?screen_name=CERN&count=10';
	...
	$getfields13 = '?screen_name=Popsci&count=10';
	$getfields14 = '?screen_name=USGS&count=10';
	$getfields15 = '?screen_name=Cmdr_Hadfield&count=10';
	...
	*/
	...
	if (!file_exists("sci.txt")){// there is no file
		$sbool = true;
		//source 1
		...
		$file = file_get_contents("sci.txt");
...
<html>
	<head>
		<title>CurrentWire: Science</title>
		...
		<link rel="icon" href="css/icons/science.png">
		<link rel="shortcut icon" sizes="256x256" href="css/icons/science.png">
		...
		<header>
			...
			<nav>
				<div class="uk-grid">
					...
					<h1 class="centre-title uk-width-1-3 uk-text-center"><span class="uk-container-center">Science News</span></h1><!-- NOTE: this will change when we introduce multiple sections-->
			...
			<div class="uk-offcanvas-bar">
				<div class="uk-panel uk-panel-header">
					...
					<ul class="uk-nav uk-nav-offcanvas" data-uk-nav>
                        ...
                        <li class="uk-active"><a href="science.php" title="Science News">Science News</a></li>
