		...
		<header>
			...
			<nav>
				<div class="uk-grid">
					...
					<h1 class="centre-title centre-title-as uk-width-1-3 uk-text-center"><span class="uk-container-center">Alternative Sports News</span></h1><!-- NOTE: this will change when we introduce multiple sections-->
