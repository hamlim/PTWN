<?php
	...
	$settings = array(
			...
			'oauth_access_token_secret' => "ICqtQRtDf1k41d11O30WNxNpL0W590dhW5ZxCQYfTfvTk",
			'consumer_key' => "VNQh1L0q8kJ8mGY0IeRNVxN52",
			'consumer_secret' => "88nkQy1MB3scR8P2v1AU8QEWWKKzG8Pea0o44A0wEaGQl3doHB"
	);
	...
	$getfields1 = '?screen_name=espn&count=10';
	$getfields2 = '?screen_name=SBNation&count=10';
	$getfields3 = '?screen_name=NFL&count=10';
	$getfields4 = '?screen_name=NBA&count=10';
	$getfields5 = '?screen_name=MLB&count=10';
	$getfields6 = '?screen_name=SportsCenter&count=10';
	$getfields7 = '?screen_name=NHL&count=10';
	$getfields8 = '?screen_name=TwitterSports&count=10';
	$getfields9 = '?screen_name=MLS&count=10';
	$getfields10 = '?screen_name=NBCSports&count=10';
	$getfields11 = '?screen_name=Deadspin&count=10';
	$getfields12 = '?screen_name=F1&count=10';
	...
	*/
	...
	if (!file_exists("sports.txt")){// there is no file
		$sbool = true;
		//source 1
		...
		$file = file_get_contents("sports.txt");
		...
		<header>
			...
			<nav>
				<div class="uk-grid">
					...
					<h1 class="centre-title uk-width-1-3 uk-text-center"><span class="uk-container-center">Sports News</span></h1><!-- NOTE: this will change when we introduce multiple sections-->
			...
			<div class="uk-offcanvas-bar">
				<div class="uk-panel uk-panel-header">
					...
					<ul class="uk-nav uk-nav-offcanvas" data-uk-nav>
						...
						<li class="uk-active"><a href="sports.php" title="Sports News">Sports News</a></li>
		...
		<div class="uk-offcanvas" id="about">
			<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
				<div class="uk-panel">
					...
					<p>Curratd was developed by Matt Hamlin (on Twitter: <a href="https://twitter.com/panteravaca" target="_newtab">@panteravaca</a>) over spring break (2014) at RPI. The idea was developed and then implemented using the Twitter API. You can find more work by Matt <a href="http://hamlim.campuslist.myrpi.org" target="_newtab">here</a>.</p>
				</div>
				<div class="uk-panel">
