<?php
	...
	$getfields1 = '?screen_name=SBNation&count=10';
	$getfields2 = '?screen_name=TwitterSports&count=10';
	$getfields3 = '?screen_name=MLS&count=10';
	$getfields4 = '?screen_name=Deadspin&count=10';
	$getfields5 = '?screen_name=F1&count=10';
	$getfields6 = '?screen_name=FIFAcom&count=10';
	$getfields7 = '?screen_name=BBCSport&count=10';
	$getfields8 = '?screen_name=NASCAR&count=10';
	$getfields9 = '?screen_name=MLUltimate&count=10';
	...
	*/
	...
	if (!file_exists("sports-alt.txt")){// there is no file
		...
		$file = file_get_contents("sports-alt.txt");
		...
		<header>
			...
			<nav>
				<div class="uk-grid">
					...
					<h1 class="centre-title uk-width-1-3 uk-text-center"><span class="uk-container-center">Alternative Sports News</span></h1><!-- NOTE: this will change when we introduce multiple sections-->
...
//			var arr15 = <?php echo $source15; ?>;
		...
		<script src="js/main-s-alt.js"></script>
