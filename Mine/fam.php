<?php
	...
	$settings = array(
			'oauth_access_token' => "118285131-R06RUOwLvyrnFLdQ3sICOCjReHH3m2g4gFJyEcO5",
			'oauth_access_token_secret' => "RFTNs9YbJOfIbo2Hvy5KhswT48kHnMmXtCoA6pmqkcATN",
			'consumer_key' => "5KN2irrKkaGwJKmx4tNyetKGe",
			'consumer_secret' => "IO7yiAcq8NNfHS0GlawEGORI4RTmwr0pDqxd0M0afkppazdN46"
	);
	...
	$getfields1 = '?screen_name=hamlinn&count=10';
...
//	$getfields15 = '?screen_name=WashingtonPost&count=10';
	...
	*/
	...
	if (!file_exists("fam.txt")){// there is no file
		$sbool = true;
		//source 1
...
//									 ->performRequest();
		...
		$file = file_get_contents("fam.txt");
